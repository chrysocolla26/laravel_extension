        ...
        for(var i=0;i<data.length;i++){
            ...
            if(rowspan > 1){
                for(var k=i;k<i+rowspan;k++){
                    ...
                    if(chkTower)
                        strHTML += '<td>'+data[k].Tower+'</td>';
                    strHTML += '<td><a onclick=
                  
                  DeleteRow("'+name+'","'+data[k].id+'","'+data[k].TableName+'")><img src="img/delete-icon.svg" width="25px" height="auto"></a>&nbsp;<a onclick=detailUpdateRow("'+name+'","'+data[k].id+'","'+data[k].TableName+'")><img src="img/delete-icon.png" width="25px" height="auto"></a></td>';
                    strHTML += '</tr>';
